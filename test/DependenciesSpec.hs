...
basicsFixtures =
  Config
    { entryPoints = EntryPoints ("." </> "test" </> "fixtures" </> "basics" </> "modules")
    , modulesDirs = [ ModulesDir
                        ("." </> "test" </> "fixtures" </> "basics" </> "node_modules")
                    ]
    , sourceDir = SourceDir ("." </> "test" </> "fixtures" </> "basics" </> "sources")
...
failingFixtures =
  Config
    { entryPoints = EntryPoints ("." </> "test" </> "fixtures" </> "failing" </> "modules")
    , modulesDirs = []
    , sourceDir = SourceDir ("." </> "test" </> "fixtures" </> "failing" </> "sources")
    , elmRoot = ElmRoot ("." </> "test" </> "fixtures" </> "failing" </> "sources")
